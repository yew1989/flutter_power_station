...
class HomeStationTile extends StatefulWidget {

  final Station data;
  final OnTapCollocted onTapCollocted;
  const HomeStationTile({Key key, this.data, this.onTapCollocted}) : super(key: key);
  
  @override
  _HomeStationTileState createState() => _HomeStationTileState();
  
}

class _HomeStationTileState extends State<HomeStationTile> {
  @override
                    ...
                    children: <Widget>[
                      ...
                      Positioned(
                        ...
                        child: SizedBox(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              if(widget.onTapCollocted == null);
                              widget.onTapCollocted() ;
                            },
                            child: Icon(Icons.star,size: 30,
                            color: station.isCollected ? Color.fromRGBO(246, 0, 46, 1) : Colors.grey),
                          ),
                        ),
                      ),
                    ],
