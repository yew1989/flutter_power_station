...
class _AboutPageState extends State<AboutPage> {
  ...
  String appInfo = '智能电站管家是福建省里的自动化设备有限公司专为智能电站1号打造的一款智能远程监控APP。';
          ...
          body: Container(
            ...
            child: ListView(
              children: <Widget>[
                ...
                SizedBox(height: 50),
                Text('【应用简介】',style: TextStyle(color: Colors.white,fontSize: 12)),
                SizedBox(height: 4),
                Text('  '+appInfo,style: TextStyle(color: Colors.white54,fontSize: 12)),
                SizedBox(height: 20),
                Text('【功能介绍】',style: TextStyle(color: Colors.white,fontSize: 12)),
                SizedBox(height: 4),
                Text('  '+desc1,style: TextStyle(color: Colors.white54,fontSize: 12)),
                SizedBox(height: 20),
                Text('  '+desc2,style: TextStyle(color: Colors.white54,fontSize: 12)),
                SizedBox(height: 20),
                Text('  '+desc3,style: TextStyle(color: Colors.white54,fontSize: 12)),
              ],
            ),
          ),
      ),
