  ...
  Widget animateNumberWidget() {
    ...
    if(controller == null || animation == null) {
      return Positioned(
        ...
        child: Center(child: RichText(text: TextSpan(text:defaultValue.toStringAsFixed(2),style: TextStyle(color: Colors.white,fontFamily: AppTheme().numberFontName,fontSize: 12)))));
    }
    else {
