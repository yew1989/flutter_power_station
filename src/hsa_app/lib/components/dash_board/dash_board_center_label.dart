  ...
  Widget build(BuildContext context) {
    return  Center(
            child: Column(
              ...
              children: <Widget>[
                Text(widget.powerNowStr ?? '',style: TextStyle(color: Colors.white,fontSize: 34,fontFamily: 'ArialNarrow')),
                SizedBox(height: 2,width:50,child: Image.asset('images/runtime/Time_line1.png')),
                SizedBox(height: 2),
                Text(widget.powerMaxStr ?? '',style: TextStyle(color: Colors.white38,fontSize: 15,fontFamily: 'ArialNarrow')),
              ],
            ),
          );
  }
