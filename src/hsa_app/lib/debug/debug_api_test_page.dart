...
class _DebugApiTestPageState extends State<DebugApiTestPage> {
  ...
  void onTapTile(int index) async {
    ...
    //电站列表
      ...
      DebugAPIStation.getStationList(isIncludeCustomer:true,isIncludeLiveLink:true,/*arrayOfStationNoOptAny:srtlist,*/page:1,pageSize:10,onSucc: (msg){
    ...
    //电站列表(单)/水轮机组信息
      ...
      DebugAPIStation.getWaterTurbineList(stationNo: "0001001",isIncludeCustomer:true,isIncludeLiveLink:true,onSucc: (msg){
    ...
    //取终端最近运行时通讯的数据(多)
      ...
      DebugAPIStation.getMultipleAFNFnpn(terminalAddress: '03740001',paramList:paramList,onSucc: (msg){
      ...
      DebugAPIStation.setFavorite(stationNo: '0339001',isFavorite:true,onSucc: (msg,_){
