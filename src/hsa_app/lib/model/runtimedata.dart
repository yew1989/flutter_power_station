class RunTimeData {
  ...
  RunTimeData({this.address,this.voltageAndCurrent,this.power,this.workSupportData,this.terminalInfo});

  RunTimeData.fromJson(Map<String, dynamic> json) {
...
class WorkSupportData {
  ...
  double relativeMaxWaterStage;
  double waterStageAlarmValue;
  double waterStage;
...
class TerminalInfo {
  ...
  bool disabled;
  List<double> periodicElectricityPrices;
  ...
  double waterTurbineRatedRPM;
  double waterTurbineRatedA;
  double waterTurbineRatedV;
  double waterTurbineExcitationCurrentA;
  ...
  TerminalInfo.fromJson(Map<String, dynamic> json) {
    ...
    periodicElectricityPrices = json['PeriodicElectricityPrices'].cast<double>();
